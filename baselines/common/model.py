...
#     Model(
#   (global_state_layer): GlobalStateLayer(
#     (linear_layer): Sequential(
#       (0): Linear(in_features=30, out_features=64, bias=True)
#       (1): ReLU()
#     )
#   )
#   (self_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(8, 8)
#     )
#     (my_buff_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(50, 6)
#     )
#     (linear_layer): Sequential(
...
#     )
#   )
#   (ally0_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
...
#     )
#   )
#   (ally1_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
...
#     )
#   )
#   (enemy0_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
...
#     )
#   )
#   (enemy1_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
...
#     )
#   )
#   (enemy2_state_layer): AgentStateLayer(
#     (my_character_type_embed_layer): EmbeddingLayer(
#       (layer): Embedding(100, 16)
#     )
#     (my_role_type_embed_layer): EmbeddingLayer(
...
#     (0): Linear(in_features=128, out_features=52, bias=True)
#   )
# )